...
std::ostream& ots::operator<<(std::ostream& os, TRB3Fragment const& f)
{
...
size_t ots::TRB3Fragment::subEventCount() const {
  size_t count = 0;
...
ots::TRB3Fragment::TRB3SubEventHeader const* ots::TRB3Fragment::subEventIndex(size_t idx) const {
