...
///          store them in the art output file but like with a Calorimeter twist :3
...
namespace emph {
  ...
  ///
  class LGCaloAna : public art::EDProducer {
  public:
  ...
  void LGCaloAna::beginRun(art::Run& run)
  {
  ...
  void LGCaloAna::GetARings(art::Handle< std::vector<rawdata::TRB3RawDigit> > & trb3H, std::unique_ptr<std::vector<rb::ARing>> & rings)
  {
//    fARICH2DHist[0]->Reset();
  ...
  //......................................................................
  void LGCaloAna::produce(art::Event& evt)
  { 
...
DEFINE_ART_MODULE(emph::LGCaloAna)
