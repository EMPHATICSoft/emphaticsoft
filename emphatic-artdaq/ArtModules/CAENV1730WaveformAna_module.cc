...
class emphaticdaq::CAENV1730WaveformAna : public art::EDAnalyzer {
...
emphaticdaq::CAENV1730WaveformAna::CAENV1730WaveformAna(fhicl::ParameterSet const & pset)
  : EDAnalyzer(pset)
{
...
emphaticdaq::CAENV1730WaveformAna::~CAENV1730WaveformAna()
{
}

void emphaticdaq::CAENV1730WaveformAna::analyze(art::Event const & evt)
{
...
DEFINE_ART_MODULE(emphaticdaq::CAENV1730WaveformAna)
