 ...
 *  +/- 1 sigma uncertainties.  Samples over a volume of about +- 0.01 sigma
 *  is close to what MINUIT does.  I think the effect of the MINUIT sample size
 *  is to reduce occurances of negative definite covariances from local,
 *  nonglobal minima.  The intent of the algorithm to find the covariances is
 *  to obtain, in the perfectly parabolic case, a resolution of 1 part in 33.
 *
...
public:
    ...
    double const finalTolerance = 0.01;   // Converge chi2 to 0.01 absolute val
