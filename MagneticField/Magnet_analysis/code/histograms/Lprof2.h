...
public:
    ...
    // Well into a new profile, and cast with Lhist2(Lprof2, bool).
    // 'cuz circular #includes.
    Lprof2 GetErrorHisto(bool RMS = true) const;



    // Filling. weight or value of Nan will be ignored.
