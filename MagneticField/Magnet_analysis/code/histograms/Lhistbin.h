...
public:
    ...
    // Bin arithmetic, the basis of histogram math.  Errors in quad.
    ...
    // Divide operator for when error propagated in quadrature
    // Modulo operator for efficiency type errors
    Lhistbin  operator/ (Lhistbin const& rhs) const;
    Lhistbin& operator/=(Lhistbin const& rhs);
    Lhistbin  operator% (Lhistbin const& rhs) const;
    Lhistbin& operator%=(Lhistbin const& rhs);
