...
namespace emph { 
  namespace ssdr {
	...
	SSDRecUpstreamTgtAutre(); // No args .. for now.. 
        ~SSDRecUpstreamTgtAutre();
	  ...
	  emph::ssdr::ConvertDigitToWCoordAutre fConvertCoord;
//
...
//	   std::cerr << " ... SSDRecUpstreamTgtAutre::SetCoeffsAlignUncert, x " << x << " y " << y << std::endl;
