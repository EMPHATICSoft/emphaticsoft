...
///          And a 3D fit using the Manetic field integrator.  See SSD3DTrackFitAutre
...
namespace emph { 
  namespace ssdr {
	...
	SSDAlign3DUVAutre(); // No args .. for now.. 
        ~SSDAlign3DUVAutre();
...
//
	  ...
	  emph::ssdr::SSD3DTrackFitFCNAutre *myNonLin3DFitPtr;
	  // Obsolete... I think..  
	  emph::ssdr::ConvertDigitToWCoordAutre myConvertX; // View is the argument.. 
	  emph::ssdr::ConvertDigitToWCoordAutre myConvertY; // One instance for each view.. Not a waste of memory, maximum dims are 8, not 22 
	  emph::ssdr::ConvertDigitToWCoordAutre myConvertU; // For sake of uniformity. 
	  emph::ssdr::ConvertDigitToWCoordAutre myConvertV; //
