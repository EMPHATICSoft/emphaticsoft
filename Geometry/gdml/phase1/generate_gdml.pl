...
<?xml version='1.0'?>
  ...
  <define>
    ...
    <rotation name="ssd52_rot" z="0" aunit="rad"/>
    ...
    <rotation name="ssd72_rot" z="0" aunit="rad"/>
    ...
    <quantity name="LG_Flange" value="20" unit="mm" />
...
print DEF <<EOF;
	 ...
	 <position name="calor_pos" x="0" y="0" z="calor_shift" unit="mm"/>
...
EOF
  ...
  print SOL <<EOF;
	 ...
	 <box name="LG_box2" x="LG_width0" y="LG_height" z="LG_length"/>
    <union name="LG_union">
