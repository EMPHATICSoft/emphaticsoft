////////////////////////////////////////////////////////////////////////
/// \brief   Example module to read in ARICH data and make a histogram for a single event 
///          
...
namespace emph {
  ...
  ///
  class ARICHMod : public art::EDProducer {
  public:
    explicit ARICHMod(fhicl::ParameterSet const& pset); // Required! explicit tag tells the compiler this is not a copy constructor
    ~ARICHMod();
  ...
  private:
    void GetARings(art::Handle< std::vector<rawdata::TRB3RawDigit> > &);
  ...
  ARICHMod::ARICHMod(fhicl::ParameterSet const& pset)
    : EDProducer(pset)
  {
  ...
  void ARICHMod::reconfigure(const fhicl::ParameterSet& pset)
  {
    arich_evt = pset.get<int>("arich_event",0);
  }
  //......................................................................
  void ARICHMod::beginJob()
  {
    art::ServiceHandle<art::TFileService> tfs;
    char hname[64];
    sprintf(hname,"ARICH2DHist_event%i",arich_evt);
    fARICH2DHist = tfs->make<TH2F>(hname,"",24,0,24,24,0,24);
  }

    
  //......................................................................
  
  void ARICHMod::endJob()
  {
    std::cout<<"Event #"<<arich_evt<<" output to root file"<<'\n';
  }
  ...
  void ARICHMod::GetARings(art::Handle< std::vector<rawdata::TRB3RawDigit> > & trb3H)
  {
	...
	if (trail_found.size()>0) {
	  ...
	  if (fEvtNum == arich_evt){
        std::cout<<"Adding hit from event "<<arich_evt<<" to the histogram with pxlx="<<pxlx<<" and pxly="<<pxly<<'\n';
  ...
  //......................................................................
  void ARICHMod::produce(art::Event& evt)
  { 
...
DEFINE_ART_MODULE(emph::ARICHMod)
